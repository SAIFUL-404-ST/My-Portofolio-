// ============================================================
// SAIF ELITE LIVE TV – FIXED PROXY & CHANNEL RESTORE
// ============================================================
(function () {
  ...
  waitForDOM(function () {
    ...
    // 🛠️ চতুর প্রক্সি মেথড: চ্যানেল ব্লক থাকলে কর্স-এনিহোয়্যার প্রক্সি ব্যবহার করবে, নাহলে ডিরেক্ট চলবে।
    function setPlayerSource(url) {
      if (playerInstance) {
        let finalUrl = url;
        
        // T Sports, GTV বা এই জাতীয় লিংকের জন্য রিভার্স প্রক্সি চালু
        if (url.includes('tsports') || url.includes('gtv') || url.includes('cdn')) {
    ...
    // 🔄 M3U গিটহাব থেকে ডিরেক্ট ফেচ (কোনো প্রক্সি ছাড়া, যাতে কোনো বাটন গায়েব না হয়)
    async function loadM3U() {
      ...
      try {
        ...
        document.getElementById('tvChannelGrid').innerHTML = '<div style="grid-column:1/-1;text-align:center;color:#ff3333;">GitHub data fetch failed.</div>';
      }
    }
